...
export default criarPagina({
  ...
  singular: "servidor",
  titulo: "Servidores",
  descricao: "Base de pessoas do SITRA. Um servidor pode virar usuario do sistema.",
  trilha: [{ rotulo: "Administracao" }, { rotulo: "Servidores" }],
  unidade: "servidores",
  ...
  colunas: [
    ...
    { chave: "matricula", rotulo: "Matricula", ordenavel: true },
    { chave: "cargo_funcao", rotulo: "Cargo / Funcao", ordenavel: true },
    ...
    },
    {
      ...
      render: (s) =>
        s.tem_usuario ? (
          <Selo texto="Tem usuario" tom="azul" />
        ) : (
  ...
  filtros: [
    { nome: "busca", rotulo: "Buscar", dica: "Nome, matricula, CPF ou e-mail" },
  ...
  formulario: [
    ...
    { nome: "matricula", rotulo: "Matricula *", obrigatorio: true },
    ...
    { nome: "cargo_funcao", rotulo: "Cargo / Funcao *", obrigatorio: true },
