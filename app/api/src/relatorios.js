...
export const MODELOS = {
  ENTRADA_SAIDA: {
    ...
    colunas: [
      ...
      { chave: "triangulo", rotulo: "Triangulo" },
    ],
    sql: `
  ...
  MANUTENCOES: {
    ...
    descricao: "Manutencoes realizadas no periodo.",
    modulo: "FROTAS",
    colunas: [
      { chave: "data", rotulo: "Data", tipo: "data" },
      { chave: "veiculo", rotulo: "Veiculo" },
      ...
      { chave: "descricao", rotulo: "Descricao do servico" },
      { chave: "oficina", rotulo: "Oficina / Fornecedor" },
      { chave: "quilometragem", rotulo: "KM do veiculo", tipo: "numero" },
      { chave: "custo", rotulo: "Custo", tipo: "dinheiro" },
      { chave: "responsavel", rotulo: "Responsavel" },
      { chave: "proxima_manutencao", rotulo: "Proxima manutencao", tipo: "data" },
  ...
  INSPECOES: {
    ...
    descricao: "Inspecoes veiculares e conformidades.",
    modulo: "FROTAS",
    colunas: [
      { chave: "numero", rotulo: "No da inspecao" },
      { chave: "data", rotulo: "Data", tipo: "data" },
      { chave: "placa", rotulo: "Placa" },
      { chave: "veiculo", rotulo: "Veiculo" },
      { chave: "tipo", rotulo: "Frequencia" },
      { chave: "responsavel", rotulo: "Responsavel" },
      { chave: "situacao", rotulo: "Situacao" },
      { chave: "resultado", rotulo: "Resultado" },
      { chave: "ressalvas", rotulo: "Itens com ressalva", tipo: "numero" },
      { chave: "proxima_inspecao", rotulo: "Proxima inspecao", tipo: "data" },
    ],
    sql: `
  ...
  SINISTROS: {
    ...
    descricao: "Ocorrencias, sinistros e acompanhamentos.",
    modulo: "FROTAS",
    colunas: [
  ...
  DOCUMENTOS: {
    ...
    colunas: [
      ...
      { chave: "placa", rotulo: "Placa" },
      { chave: "veiculo", rotulo: "Veiculo" },
      { chave: "numero_documento", rotulo: "No / Referencia" },
      { chave: "data_emissao", rotulo: "Emissao", tipo: "data" },
